...
use sctk::{
    ...
    registry_handlers,
    seat::{Capability, SeatHandler, SeatState, keyboard::{KeyEvent, KeyboardHandler, Keysym, Modifiers}},
    reexports::client::protocol::{wl_keyboard, wl_surface, wl_seat},
...
pub fn get_modifiers_state() -> Result<Option<super::ModifiersState>> {
    ...
    event_loop.dispatch(Duration::from_millis(1000), &mut state).unwrap();
