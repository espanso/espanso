...
For example, specifying 'email' is equivalent to 'match/email.yml'."#))
    ...
    .subcommand(SubCommand::with_name("match")
        ...
        .subcommand(SubCommand::with_name("add")
            .about("Add a new text match to a YAML file")
            .arg(Arg::with_name("trigger")
                .short('t')
                .long("trigger")
                .help("The trigger text to expand, for example ':hello'")
                .required(true)
                .takes_value(true)
            )
            .arg(Arg::with_name("replace")
                .short('r')
                .long("replace")
                .help("The replacement text expanded when trigger is typed")
                .required(true)
                .takes_value(true)
            )
            .arg(Arg::with_name("label")
                .long("label")
                .help("Optional descriptive label used by search UI")
                .required(false)
                .takes_value(true)
            )
            .arg(Arg::with_name("target_file")
                .long("file")
                .help(r#"Target file path. Defaults to "match/base.yml". You can pass either a relative path such as "match/snippets.yml" or a short name like "snippets"."#)
                .required(false)
                .takes_value(true)
            )
        )
